...
Los datos utilizados en este proyecto corresponden a registros de sensores
inerciales colocados en diferentes segmentos del brazo (mano, antebrazo y
bíceps). Cada archivo contiene series temporales de aceleración y velocidad
angular utilizadas para construir las características del modelo.
